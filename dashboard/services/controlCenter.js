    ...
    groups: [
      ...
      },
      {
        ...
        fields: [
          ...
          toggle("filterEnabled", "automod.filter_enabled", { runtime: true }),
          text("filterTerms", "automod.filter_terms", 4000, { multiline: true, runtime: true }),
          text("filterExceptions", "automod.filter_exceptions", 4000, { multiline: true, runtime: true }),
          choice("filterMatchMode", "automod.filter_match_mode", ["CONTAINS", "WORD", "EXACT"], { runtime: true }),
          toggle("filterCaseSensitive", "automod.filter_case_sensitive", { runtime: true }),
          toggle("filterDelete", "automod.filter_delete", { runtime: true }),
          number("filterStrikes", "automod.filter_strikes", 0, 10, { runtime: true }),
          number("maxMentions", "automod.max_mentions", 1, 50, { runtime: true }),
          number("maxRoleMentions", "automod.max_role_mentions", 0, 20, { runtime: true }),
          number("antiMassMention", "automod.anti_massmention", 0, 50, { runtime: true }),
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    groups: [
      { id: "roulette", fields: [toggle("roulette", "control_center.fun.roulette_enabled", { runtime: true })] },
      {
        id: "forestFuss",
        fields: [
          toggle("forestFuss", "control_center.fun.forest_fuss_enabled", { runtime: true }),
          channel("fussCategory", "control_center.fun.category_id", "category", { runtime: true }),
          number("fussSessions", "control_center.fun.max_sessions", 1, 20, { runtime: true }),
          number("fussPlayers", "control_center.fun.max_players", 4, 100, { runtime: true }),
          text("fussLobby", "control_center.fun.lobby_name", 100, { runtime: true }),
          text("fussWolves", "control_center.fun.wolves_name", 100, { runtime: true }),
          toggle("fussLeaders", "control_center.fun.leaders_only", { runtime: true }),
          number("fussRecruitment", "control_center.fun.recruitment_seconds", 15, 3600, { runtime: true }),
          number("fussDay", "control_center.fun.day_seconds", 30, 3600, { runtime: true }),
          number("fussNight", "control_center.fun.night_seconds", 30, 3600, { runtime: true }),
          number("fussResults", "control_center.fun.result_seconds", 5, 600, { runtime: true }),
        ],
      },
    ],
  },
