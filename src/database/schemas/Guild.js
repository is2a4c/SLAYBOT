...
const Schema = new mongoose.Schema({
      ...
      level: [
        {
          ...
          threshold: { type: Number, required: true, min: 2, max: 10000 },
      ...
      voice: [
        {
          _id: false,
          id: { type: String, required: true },
          threshold: { type: Number, required: true, min: 300, max: 315360000 },
          add_roles: { type: [String], default: [] },
          remove_roles: { type: [String], default: [] },
        },
      ],
  ...
  ticket: {
    ...
    opening_color: { type: String, default: null },
    opening_footer: {
      type: String,
      default: "You may close your ticket anytime by clicking the button below",
      maxlength: 200,
    },
    ping_member: { type: Boolean, default: true },
    dm_on_create: { type: Boolean, default: true },
    dm_on_close: { type: Boolean, default: true },
  ...
  automod: {
    ...
    anti_caps: { type: Boolean, default: false },
    caps_min_letters: { type: Number, default: 8, min: 1, max: 1000 },
    caps_percent: { type: Number, default: 75, min: 10, max: 100 },
    anti_emoji: { type: Boolean, default: false },
    max_emoji: { type: Number, default: 12, min: 1, max: 100 },
    anti_zalgo: { type: Boolean, default: false },
    zalgo_percent: { type: Number, default: 30, min: 1, max: 100 },
    anti_scam: { type: Boolean, default: false },
    reset_strikes_on_action: { type: Boolean, default: false },
    escalation_rules: [
      {
        _id: false,
        id: { type: String, required: true },
        threshold: { type: Number, required: true, min: 1, max: 1000 },
        action: { type: String, required: true, enum: ["TIMEOUT", "KICK", "BAN"] },
        timeout_minutes: { type: Number, default: 1440, min: 1, max: 40320 },
      },
    ],
  ...
  welcome: {
    ...
    channel: String,
    content: String,
    allow_bots: { type: Boolean, default: true },
    embed: {
      title: { type: String, default: null, maxlength: 256 },
      author: { type: String, default: null, maxlength: 256 },
      description: String,
      color: String,
      thumbnail: Boolean,
      footer: String,
  ...
  modmail: {
    ...
    intro_message: {
      type: String,
      default: "New modmail thread. Reply with `/modmail reply` or type here when reply mirroring is enabled.",
      maxlength: 1000,
    },
    intro_color: { type: String, default: null },
    incoming_color: { type: String, default: null },
    reply_color: { type: String, default: null },
    show_attachments: { type: Boolean, default: true },
    member_ack_emoji: { type: String, default: "📨", maxlength: 100 },
    staff_ack_emoji: { type: String, default: "✅", maxlength: 100 },
  ...
  starboard: {
    ...
    show_jump_link: { type: Boolean, default: true },
    show_images: { type: Boolean, default: true },
    show_attachments: { type: Boolean, default: true },
    show_timestamp: { type: Boolean, default: true },
    content_length: { type: Number, default: 3800, min: 100, max: 3800 },
  },
  suggestions: {
    enabled: Boolean,
    channel_id: String,
    ...
    staff_roles: [String],
    anonymous: { type: Boolean, default: false },
    voting_enabled: { type: Boolean, default: true },
    upvote_emoji: { type: String, default: "⬆️", maxlength: 100 },
    downvote_emoji: { type: String, default: "⬇️", maxlength: 100 },
    default_color: { type: String, default: null },
    approved_color: { type: String, default: null },
    rejected_color: { type: String, default: null },
    move_processed: { type: Boolean, default: true },
    approve_label: { type: String, default: "Approve", maxlength: 80 },
    reject_label: { type: String, default: "Reject", maxlength: 80 },
    delete_label: { type: String, default: "Delete", maxlength: 80 },
  },
  ai: {
    enabled: { type: Boolean, default: false },
  ...
  control_center: {
    common: {
      ...
      text_commands: { type: Boolean, default: true },
      admin_roles: { type: [String], default: [] },
      autorole_always: { type: Boolean, default: false },
      restore_nickname: { type: Boolean, default: false },
    },
    moderation: {
      moderator_roles: { type: [String], default: [] },
      cooldown_exempt: { type: Boolean, default: true },
      respect_role_hierarchy: { type: Boolean, default: true },
      warning_expiry_days: { type: Number, default: 30, min: 0, max: 3650 },
      default_mute_scope: { type: String, enum: ["ALL", "TEXT", "VOICE"], default: "ALL" },
      block_reactions: { type: Boolean, default: false },
      mute_mode: { type: String, enum: ["TIMEOUT", "ROLE", "BOTH"], default: "TIMEOUT" },
      mute_role: { type: String, default: null },
      mute_excluded_channels: { type: [String], default: [] },
    },
    music: {
      channel_id: { type: String, default: null },
      allow_any_channel: { type: Boolean, default: true },
      dj_roles: { type: [String], default: [] },
      default_source: {
        type: String,
        enum: ["YOUTUBE", "YANDEX", "SPOTIFY", "SOUNDCLOUD"],
        default: "YOUTUBE",
      },
      compact_queue: { type: Boolean, default: true },
      delete_notices: { type: Boolean, default: false },
      progress_bar: { type: Boolean, default: true },
      autoplay_enabled: { type: Boolean, default: false },
      autoplay_query: { type: String, default: null, maxlength: 500 },
      autoplay_output_channel: { type: String, default: null },
      max_queue_per_user: { type: Number, default: 25, min: 1, max: 500 },
      max_track_minutes: { type: Number, default: 180, min: 1, max: 1440 },
    },
    ranking: {
      public_page: { type: Boolean, default: false },
      reset_on_leave: { type: Boolean, default: false },
      ignored_roles: { type: [String], default: [] },
      ignored_text_channels: { type: [String], default: [] },
      text_multiplier: { type: Number, default: 1, min: 0, max: 100 },
      voice_enabled: { type: Boolean, default: false },
      ignored_voice_channels: { type: [String], default: [] },
      voice_multiplier: { type: Number, default: 1, min: 0, max: 100 },
      max_members: { type: Number, default: 10000, min: 100, max: 1000000 },
      card_accent: { type: String, default: null },
      card_background: { type: String, default: null },
    },
    notifications: {
      welcome_dm: { type: Boolean, default: false },
      boost_enabled: { type: Boolean, default: false },
      boost_channel: { type: String, default: null },
      boost_message: { type: String, default: null, maxlength: 1000 },
      boost_title: { type: String, default: null, maxlength: 256 },
      boost_author: { type: String, default: null, maxlength: 256 },
      boost_color: { type: String, default: null },
      boost_thumbnail: { type: Boolean, default: true },
      boost_footer: { type: String, default: null, maxlength: 200 },
      boost_image: { type: String, default: null },
      boost_timestamp: { type: Boolean, default: true },
      boost_fields: fieldsPath(),
      boost_buttons: buttonsPath(),
      dm_on_ban: { type: Boolean, default: true },
      dm_on_kick: { type: Boolean, default: true },
      dm_on_mute: { type: Boolean, default: true },
      dm_on_warn: { type: Boolean, default: true },
    },
    fun: {
      roulette_enabled: { type: Boolean, default: false },
      forest_fuss_enabled: { type: Boolean, default: false },
      category_id: { type: String, default: null },
      max_sessions: { type: Number, default: 1, min: 1, max: 20 },
      max_players: { type: Number, default: 20, min: 4, max: 100 },
      lobby_name: { type: String, default: "forest-lobby", maxlength: 100 },
      wolves_name: { type: String, default: "wolves", maxlength: 100 },
      leaders_only: { type: Boolean, default: true },
      recruitment_seconds: { type: Number, default: 120, min: 15, max: 3600 },
      day_seconds: { type: Number, default: 180, min: 30, max: 3600 },
      night_seconds: { type: Number, default: 120, min: 30, max: 3600 },
      result_seconds: { type: Number, default: 30, min: 5, max: 600 },
    },
  },
});
